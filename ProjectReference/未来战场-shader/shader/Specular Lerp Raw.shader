Shader "VX/FX/Specular Lerp Raw" {
Properties {
...
void main ()
{
  ...
  lowp vec3 tmpvar_3;
  tmpvar_3 = ((tmpvar_2 + (texture2D (_FXTex, xlv_TEXCOORD0) * _Weight)).xyz * _Color.xyz);
  lowp float tmpvar_4;
  ...
  tmpvar_12 = (pow (nh_8, y_11) * tmpvar_2.w);
...
void main ()
{
  ...
  lowp vec3 tmpvar_3;
  tmpvar_3 = ((tmpvar_2 + (texture (_FXTex, xlv_TEXCOORD0) * _Weight)).xyz * _Color.xyz);
  lowp float tmpvar_4;
  tmpvar_4 = (tmpvar_2.w * _Color.w);
  highp vec3 tmpvar_5;
  tmpvar_5 = normalize(xlv_TEXCOORD3);
...
void main ()
{
  ...
  ).xyz * _Color.xyz) * (2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz));
...
void main ()
{
  ...
  ).xyz * _Color.xyz) * (2.0 * texture (unity_Lightmap, xlv_TEXCOORD1).xyz));
  c_1.w = (tmpvar_2.w * _Color.w);
  _glesFragData[0] = c_1;
}
...
void main ()
{
  ...
  highp float tmpvar_18;
  tmpvar_18 = (pow (nh_14, y_17) * tmpvar_2.w);
...
void main ()
{
  ...
  c_1.xyz = (((tmpvar_2 + 
    (texture2D (_FXTex, xlv_TEXCOORD0) * _Weight)
  ).xyz * _Color.xyz) * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz), vec3((tmpvar_3 * 2.0))));
  c_1.w = (tmpvar_2.w * _Color.w);
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  highp float tmpvar_15;
  tmpvar_15 = (pow (nh_11, y_14) * tmpvar_2.w);
  highp vec3 tmpvar_16;
  tmpvar_16 = (((
    (tmpvar_3 * _LightColor0.xyz)
   * tmpvar_12) + (
...
void main ()
{
  ...
  tmpvar_16 = (pow (nh_12, y_15) * tmpvar_2.w);
...
void main ()
{
  ...
  c_1.xyz = (((tmpvar_2 + 
    (texture2D (_FXTex, xlv_TEXCOORD0) * _Weight)
  ).xyz * _Color.xyz) * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz), vec3((shadow_3 * 2.0))));
  c_1.w = (tmpvar_2.w * _Color.w);
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  c_1.xyz = (((tmpvar_2 + 
    (texture (_FXTex, xlv_TEXCOORD0) * _Weight)
  ).xyz * _Color.xyz) * min ((2.0 * texture (unity_Lightmap, xlv_TEXCOORD1).xyz), vec3((shadow_3 * 2.0))));
  c_1.w = (tmpvar_2.w * _Color.w);
  _glesFragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_16 = max (0.0, normalize((
    normalize((((scalePerBasisVector_12.x * vec3(0.816497, 0.0, 0.57735)) + (scalePerBasisVector_12.y * vec3(-0.408248, 0.707107, 0.57735))) + (scalePerBasisVector_12.z * vec3(-0.408248, -0.707107, 0.57735))))
   + viewDir_9)).z);
  nh_11 = tmpvar_16;
  highp float tmpvar_17;
  mediump float y_18;
  y_18 = (_Shininess * 128.0);
  tmpvar_17 = pow (nh_11, y_18);
  highp vec3 tmpvar_19;
...
void main ()
{
  ...
  tmpvar_17 = max (0.0, normalize((
    normalize((((scalePerBasisVector_13.x * vec3(0.816497, 0.0, 0.57735)) + (scalePerBasisVector_13.y * vec3(-0.408248, 0.707107, 0.57735))) + (scalePerBasisVector_13.z * vec3(-0.408248, -0.707107, 0.57735))))
   + viewDir_10)).z);
  nh_12 = tmpvar_17;
  highp float tmpvar_18;
  mediump float y_19;
  y_19 = (_Shininess * 128.0);
  tmpvar_18 = pow (nh_12, y_19);
  ...
  lowp vec3 tmpvar_22;
  tmpvar_22 = vec3((shadow_4 * 2.0));
  mediump vec3 tmpvar_23;
  tmpvar_23 = (c_1.xyz + (tmpvar_3 * min (tmpvar_9.xyz, tmpvar_22)));
  c_1.xyz = tmpvar_23;
  c_1.w = (tmpvar_2.w * _Color.w);
  _glesFragData[0] = c_1;
}
...
void main ()
{
  ...
  lowp vec3 tmpvar_4;
  tmpvar_4 = ((tmpvar_3 + (texture2D (_FXTex, xlv_TEXCOORD0) * _Weight)).xyz * _Color.xyz);
  lowp float tmpvar_5;
  ...
  tmpvar_12 = max (0.0, dot (xlv_TEXCOORD1, normalize(
    (lightDir_2 + normalize(xlv_TEXCOORD3))
  )));
  nh_10 = tmpvar_12;
  mediump float y_13;
  y_13 = (_Shininess * 128.0);
  highp float tmpvar_14;
  tmpvar_14 = (pow (nh_10, y_13) * tmpvar_3.w);
  highp vec3 tmpvar_15;
  tmpvar_15 = (((
    (tmpvar_4 * _LightColor0.xyz)
   * tmpvar_11) + (
    (_LightColor0.xyz * _SpecColor.xyz)
   * tmpvar_14)) * (atten_8 * 2.0));
  c_9.xyz = tmpvar_15;
  highp float tmpvar_16;
  tmpvar_16 = (tmpvar_5 + ((
    (_LightColor0.w * _SpecColor.w)
...
void main ()
{
  ...
  lowp vec3 tmpvar_4;
  tmpvar_4 = ((tmpvar_3 + (texture (_FXTex, xlv_TEXCOORD0) * _Weight)).xyz * _Color.xyz);
  lowp float tmpvar_5;
  tmpvar_5 = (tmpvar_3.w * _Color.w);
  mediump vec3 tmpvar_6;
  tmpvar_6 = normalize(xlv_TEXCOORD2);
...
void main ()
{
  ...
  tmpvar_9 = max (0.0, dot (xlv_TEXCOORD1, normalize(
    (lightDir_2 + normalize(xlv_TEXCOORD3))
  )));
  nh_7 = tmpvar_9;
  mediump float y_10;
  y_10 = (_Shininess * 128.0);
  highp float tmpvar_11;
  tmpvar_11 = (pow (nh_7, y_10) * tmpvar_3.w);
...
void main ()
{
  ...
  y_14 = (_Shininess * 128.0);
  highp float tmpvar_15;
  tmpvar_15 = (pow (nh_11, y_14) * tmpvar_3.w);
  highp vec3 tmpvar_16;
  tmpvar_16 = (((
    (tmpvar_4 * _LightColor0.xyz)
   * tmpvar_12) + (
    (_LightColor0.xyz * _SpecColor.xyz)
   * tmpvar_15)) * (atten_9 * 2.0));
  c_10.xyz = tmpvar_16;
  highp float tmpvar_17;
  tmpvar_17 = (tmpvar_5 + ((
    (_LightColor0.w * _SpecColor.w)
...
void main ()
{
  ...
  y_11 = (_Shininess * 128.0);
  highp float tmpvar_12;
  tmpvar_12 = (pow (nh_8, y_11) * tmpvar_3.w);
  highp vec3 tmpvar_13;
  tmpvar_13 = (((
    (tmpvar_4 * _LightColor0.xyz)
   * tmpvar_9) + (
    (_LightColor0.xyz * _SpecColor.xyz)
   * tmpvar_12)) * (atten_6 * 2.0));
  c_7.xyz = tmpvar_13;
  highp float tmpvar_14;
  tmpvar_14 = (tmpvar_5 + ((
    (_LightColor0.w * _SpecColor.w)
...
void main ()
{
  ...
  lowp vec3 tmpvar_5;
  tmpvar_5 = ((tmpvar_4 + (texture2D (_FXTex, xlv_TEXCOORD0) * _Weight)).xyz * _Color.xyz);
  lowp vec4 tmpvar_6;
...
void main ()
{
  ...
  lowp vec3 tmpvar_5;
  tmpvar_5 = ((tmpvar_4 + (texture (_FXTex, xlv_TEXCOORD0) * _Weight)).xyz * _Color.xyz);
  lowp vec4 tmpvar_6;
...
void main ()
{
  ...
  lowp vec3 tmpvar_8;
  tmpvar_8 = ((tmpvar_7 + (texture2D (_FXTex, xlv_TEXCOORD0) * _Weight)).xyz * _Color.xyz);
  lowp vec4 tmpvar_9;
...
void main ()
{
  ...
  lowp vec3 tmpvar_8;
  tmpvar_8 = ((tmpvar_7 + (texture (_FXTex, xlv_TEXCOORD0) * _Weight)).xyz * _Color.xyz);
  lowp vec4 tmpvar_9;
