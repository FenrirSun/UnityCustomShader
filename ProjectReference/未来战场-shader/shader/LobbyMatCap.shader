Shader "VX/Character New/LobbyMatCap" {
Properties {
...
void main ()
{
  ...
  tmpvar_12.x = dot (xlv_TEXCOORD5, tmpvar_6);
  tmpvar_12.y = dot (xlv_TEXCOORD6, tmpvar_6);
  mediump vec2 tmpvar_13;
  tmpvar_13 = ((tmpvar_12 * 0.5) + 0.5);
  mediump float tmpvar_14;
  tmpvar_14 = clamp (((
    (1.0 - dot (tmpvar_8, tmpvar_6))
   - _EdgeIn) / (_EdgeOut - _EdgeIn)), 0.0, 1.0);
  mediump vec3 tmpvar_15;
  tmpvar_15 = (_RimColor.xyz * (tmpvar_14 * (tmpvar_14 * 
    (3.0 - (2.0 * tmpvar_14))
  )));
  rim_1 = tmpvar_15;
  lowp vec3 tmpvar_16;
  tmpvar_16 = ((finalColor_4 + (texture2D (_MatCap, tmpvar_13).xyz * tmpvar_7.z)) + (rim_1 * tmpvar_7.x));
  finalColor_4 = tmpvar_16;
  lowp vec4 tmpvar_17;
  tmpvar_17.w = 1.0;
...
void main ()
{
  ...
  rim_1 = tmpvar_15;
  lowp vec3 tmpvar_16;
  tmpvar_16 = ((finalColor_4 + (texture (_MatCap, tmpvar_13).xyz * tmpvar_7.z)) + (rim_1 * tmpvar_7.x));
  finalColor_4 = tmpvar_16;
  lowp vec4 tmpvar_17;
  tmpvar_17.w = 1.0;
  tmpvar_17.xyz = tmpvar_16;
...
void main ()
{
  ...
  tmpvar_18.x = dot (xlv_TEXCOORD5, tmpvar_6);
  tmpvar_18.y = dot (xlv_TEXCOORD6, tmpvar_6);
  mediump vec2 tmpvar_19;
  tmpvar_19 = ((tmpvar_18 * 0.5) + 0.5);
  mediump float tmpvar_20;
  tmpvar_20 = clamp (((
    (1.0 - dot (tmpvar_14, tmpvar_6))
   - _EdgeIn) / (_EdgeOut - _EdgeIn)), 0.0, 1.0);
  mediump vec3 tmpvar_21;
  tmpvar_21 = (_RimColor.xyz * (tmpvar_20 * (tmpvar_20 * 
    (3.0 - (2.0 * tmpvar_20))
  )));
  rim_1 = tmpvar_21;
  lowp vec3 tmpvar_22;
  tmpvar_22 = ((finalColor_4 + (texture2D (_MatCap, tmpvar_19).xyz * tmpvar_7.z)) + (rim_1 * tmpvar_7.x));
  finalColor_4 = tmpvar_22;
  lowp vec4 tmpvar_23;
  tmpvar_23.w = 1.0;
...
void main ()
{
  ...
  tmpvar_15.x = dot (xlv_TEXCOORD5, tmpvar_6);
  tmpvar_15.y = dot (xlv_TEXCOORD6, tmpvar_6);
  mediump vec2 tmpvar_16;
  tmpvar_16 = ((tmpvar_15 * 0.5) + 0.5);
  mediump float tmpvar_17;
  tmpvar_17 = clamp (((
    (1.0 - dot (tmpvar_11, tmpvar_6))
   - _EdgeIn) / (_EdgeOut - _EdgeIn)), 0.0, 1.0);
  mediump vec3 tmpvar_18;
  tmpvar_18 = (_RimColor.xyz * (tmpvar_17 * (tmpvar_17 * 
    (3.0 - (2.0 * tmpvar_17))
  )));
  rim_1 = tmpvar_18;
  lowp vec3 tmpvar_19;
  tmpvar_19 = ((finalColor_4 + (texture2D (_MatCap, tmpvar_16).xyz * tmpvar_7.z)) + (rim_1 * tmpvar_7.x));
  finalColor_4 = tmpvar_19;
  lowp vec4 tmpvar_20;
  tmpvar_20.w = 1.0;
...
void main ()
{
  ...
  mediump vec2 tmpvar_16;
  tmpvar_16.x = dot (xlv_TEXCOORD5, tmpvar_6);
  tmpvar_16.y = dot (xlv_TEXCOORD6, tmpvar_6);
  ...
  rim_1 = tmpvar_19;
  lowp vec3 tmpvar_20;
  tmpvar_20 = ((finalColor_4 + (texture (_MatCap, tmpvar_17).xyz * tmpvar_7.z)) + (rim_1 * tmpvar_7.x));
