Shader "VX/Scene New/Diffuse Fog VertexColorBlend3BrightMap" {
Properties {
 _Color ("Main Color", Color) = (1,1,1,1)
 _ColorTexR ("Color Map R (RGB)", 2D) = "white" {}
 _ColorTexG ("Color Map G (RGB)", 2D) = "white" {}
 _ColorTexB ("Color Map B (RGB)", 2D) = "white" {}
 _ColorTexA ("Color Map A (RGB)", 2D) = "white" {}
}
SubShader { 
 LOD 400
...
void main ()
{
  ...
  xlv_TEXCOORD1 = (tmpvar_5 * (normalize(_glesNormal) * unity_Scale.w));
...
void main ()
{
  ...
  xlv_TEXCOORD3 = tmpvar_2;
  xlv_TEXCOORD4 = tmpvar_3;
  xlv_TEXCOORD5 = (unity_World2Shadow[0] * cse_7);
}
...
void main ()
{
  ...
  highp float dist_4;
  lowp float tmpvar_5;
  tmpvar_5 = texture2DProj (_ShadowMapTexture, xlv_TEXCOORD5).x;
  dist_4 = tmpvar_5;
...
void main ()
{
  ...
  lowp float shadow_3;
  lowp float tmpvar_4;
  tmpvar_4 = shadow2DEXT (_ShadowMapTexture, xlv_TEXCOORD5.xyz);
...
void main ()
{
  ...
  tmpvar_4 = texture (_ShadowMapTexture, xlv_TEXCOORD5.xyz);
  lowp float tmpvar_5;
  tmpvar_5 = tmpvar_4;
  highp float tmpvar_6;
...
void main ()
{
  ...
  lowp float shadow_2;
  lowp float tmpvar_3;
  tmpvar_3 = shadow2DEXT (_ShadowMapTexture, xlv_TEXCOORD5.xyz);
...
void main ()
{
  ...
  tmpvar_3 = texture (_ShadowMapTexture, xlv_TEXCOORD5.xyz);
  lowp float tmpvar_4;
  tmpvar_4 = tmpvar_3;
  highp float tmpvar_5;
  tmpvar_5 = (_LightShadowData.x + (tmpvar_4 * (1.0 - _LightShadowData.x)));
...
void main ()
{
  ...
  gl_Position = (glstate_matrix_mvp * _glesVertex);
  xlv_TEXCOORD0 = tmpvar_1;
  xlv_TEXCOORD1 = (tmpvar_6 * (normalize(_glesNormal) * unity_Scale.w));
  xlv_COLOR = tmpvar_2;
  xlv_TEXCOORD3 = tmpvar_3;
  xlv_TEXCOORD4 = tmpvar_4;
}
...
void main ()
{
  ...
  xlv_TEXCOORD3 = tmpvar_4;
  xlv_TEXCOORD4 = tmpvar_5;
  xlv_TEXCOORD5 = (unity_World2Shadow[0] * cse_9);
}
