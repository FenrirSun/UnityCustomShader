Shader "VX/Scene New/Specular Reflect Mask Fog RGB" {
Properties {
...
void main ()
{
  ...
  tmpvar_14 = (_WorldSpaceCameraPos - cse_9.xyz);
...
void main ()
{
  ...
  tmpvar_13[0] = glstate_matrix_mvp[0].xyz;
  tmpvar_13[1] = glstate_matrix_mvp[1].xyz;
  tmpvar_13[2] = glstate_matrix_mvp[2].xyz;
  highp vec2 tmpvar_14;
  tmpvar_14 = (((
    (tmpvar_7.xy / tmpvar_7.w)
   + 
    (normalize((tmpvar_13 * tmpvar_1)).xz * _ReflectLevel)
  ) * vec2(0.5, 0.5)) + vec2(0.5, 0.5));
  tmpvar_6 = tmpvar_14;
  tmpvar_5.xyz = _FogColor.xyz;
  highp vec3 tmpvar_15;
  tmpvar_15 = (_WorldSpaceCameraPos - cse_10.xyz);
  highp float tmpvar_16;
...
void main ()
{
  ...
  tmpvar_9 = (((
   ...
   + 
    (normalize((tmpvar_8 * normalize(_glesNormal))).xz * _ReflectLevel)
  ) * vec2(0.5, 0.5)) + vec2(0.5, 0.5));
  tmpvar_4 = tmpvar_9;
...
void main ()
{
  ...
  tmpvar_16[0] = glstate_matrix_mvp[0].xyz;
  tmpvar_16[1] = glstate_matrix_mvp[1].xyz;
  tmpvar_16[2] = glstate_matrix_mvp[2].xyz;
  highp vec2 tmpvar_17;
  tmpvar_17 = (((
    (tmpvar_8.xy / tmpvar_8.w)
   + 
    (normalize((tmpvar_16 * tmpvar_1)).xz * _ReflectLevel)
  ) * vec2(0.5, 0.5)) + vec2(0.5, 0.5));
  tmpvar_7 = tmpvar_17;
...
void main ()
{
  ...
  xlv_TEXCOORD1 = tmpvar_3;
  xlv_TEXCOORD2 = tmpvar_4;
  xlv_TEXCOORD3 = (unity_World2Shadow[0] * cse_10);
  xlv_COLOR = tmpvar_5;
  xlv_TEXCOORD6 = tmpvar_6;
}
