Shader "VX/Character/CharacterLobby" {
Properties {
 _MainTex ("Base (RGB)", 2D) = "grey" {}
 _NormalMap ("NormalMap", 2D) = "black" {}
 _MatCap ("MatCap (RGB)", 2D) = "grey" {}
 _Cube ("Cube", CUBE) = "black" {}
 _LightMap ("R(Rim Coef) G(Matcap),B(CubeMap)", 2D) = "grey" {}
...
void main ()
{
  ...
  final_3 = tmpvar_10;
  lowp vec4 tmpvar_11;
  tmpvar_11 = (final_3 + (textureCube (_Cube, xlv_TEXCOORD4) * clamp (
    ((tmpvar_5.z * 2.0) - 1.0)
  , 0.0, 1.0)));
  final_3.w = tmpvar_11.w;
...
void main ()
{
  ...
  final_3 = tmpvar_10;
  lowp vec4 tmpvar_11;
  tmpvar_11 = (final_3 + (texture (_Cube, xlv_TEXCOORD4) * clamp (
    ((tmpvar_5.z * 2.0) - 1.0)
  , 0.0, 1.0)));
  final_3.w = tmpvar_11.w;
  highp vec3 tmpvar_12;
