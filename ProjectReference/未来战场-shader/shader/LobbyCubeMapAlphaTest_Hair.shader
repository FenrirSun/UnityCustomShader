...
void main ()
{
  ...
  lowp vec4 tmpvar_25;
  tmpvar_25 = texture2D (_Alpha, xlv_TEXCOORD0);
  lowp float x_26;
...
void main ()
{
  ...
  finalColor_8 = tmpvar_24;
  lowp vec4 tmpvar_25;
  tmpvar_25 = texture (_Alpha, xlv_TEXCOORD0);
  lowp float x_26;
  x_26 = (tmpvar_25.x - _Cutoff);
  if ((x_26 < 0.0)) {
    discard;
...
void main ()
{
  ...
  lowp vec4 tmpvar_31;
  tmpvar_31 = texture2D (_Alpha, xlv_TEXCOORD0);
  lowp float x_32;
...
void main ()
{
  ...
  lowp vec4 tmpvar_28;
  tmpvar_28 = texture2D (_Alpha, xlv_TEXCOORD0);
  lowp float x_29;
  x_29 = (tmpvar_28.x - _Cutoff);
  if ((x_29 < 0.0)) {
    discard;
  };
  lowp vec4 tmpvar_30;
  tmpvar_30.xyz = tmpvar_27;
  tmpvar_30.w = tmpvar_28.x;
...
void main ()
{
  ...
  lowp vec4 tmpvar_29;
  tmpvar_29 = texture (_Alpha, xlv_TEXCOORD0);
  lowp float x_30;
  x_30 = (tmpvar_29.x - _Cutoff);
  if ((x_30 < 0.0)) {
    discard;
  };
  lowp vec4 tmpvar_31;
  tmpvar_31.xyz = tmpvar_28;
  tmpvar_31.w = tmpvar_29.x;
...
void main ()
{
  ...
  lowp vec4 tmpvar_13;
  tmpvar_13 = texture2D (_Alpha, xlv_TEXCOORD0);
  lowp float x_14;
  x_14 = (tmpvar_13.x - _Cutoff);
  if ((x_14 < 0.0)) {
    discard;
  };
  lowp vec4 tmpvar_15;
...
void main ()
{
  ...
  finalColor_3 = tmpvar_12;
  lowp vec4 tmpvar_13;
  tmpvar_13 = texture (_Alpha, xlv_TEXCOORD0);
  lowp float x_14;
  x_14 = (tmpvar_13.x - _Cutoff);
  if ((x_14 < 0.0)) {
    discard;
...
void main ()
{
  ...
  lowp vec4 tmpvar_10;
  tmpvar_10 = texture2D (_Alpha, xlv_TEXCOORD0);
  lowp float x_11;
...
void main ()
{
  ...
  finalColor_3 = tmpvar_9;
  lowp vec4 tmpvar_10;
  tmpvar_10 = texture (_Alpha, xlv_TEXCOORD0);
  lowp float x_11;
  x_11 = (tmpvar_10.x - _Cutoff);
  if ((x_11 < 0.0)) {
    discard;
...
void main ()
{
  ...
  lowp vec4 tmpvar_17;
  tmpvar_17 = texture2D (_Alpha, xlv_TEXCOORD0);
  lowp float x_18;
  x_18 = (tmpvar_17.x - _Cutoff);
  if ((x_18 < 0.0)) {
    discard;
  };
  lowp vec4 tmpvar_19;
...
void main ()
{
  ...
  finalColor_3 = tmpvar_16;
  lowp vec4 tmpvar_17;
  tmpvar_17 = texture (_Alpha, xlv_TEXCOORD0);
  lowp float x_18;
  x_18 = (tmpvar_17.x - _Cutoff);
  if ((x_18 < 0.0)) {
    discard;
...
void main ()
{
  ...
  lowp vec4 tmpvar_11;
  tmpvar_11 = texture2D (_Alpha, xlv_TEXCOORD0);
  lowp float x_12;
...
void main ()
{
  ...
  finalColor_3 = tmpvar_10;
  lowp vec4 tmpvar_11;
  tmpvar_11 = texture (_Alpha, xlv_TEXCOORD0);
  lowp float x_12;
  x_12 = (tmpvar_11.x - _Cutoff);
  if ((x_12 < 0.0)) {
    discard;
