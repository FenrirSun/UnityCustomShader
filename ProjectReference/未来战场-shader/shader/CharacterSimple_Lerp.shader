Shader "VX/Character/CharacterSimple_Lerp" {
Properties {
...
void main ()
{
  ...
  final_1 = tmpvar_7;
  lowp vec4 tmpvar_8;
  tmpvar_8 = (final_1 + (texture2D (_FXTex, xlv_TEXCOORD1.xy) * _Weight));
  final_1.w = tmpvar_8.w;
  mediump vec3 tmpvar_9;
  tmpvar_9 = (tmpvar_8.xyz + (Albedo_3.xyz * xlv_TEXCOORD0));
  final_1.xyz = tmpvar_9;
  lowp vec4 tmpvar_10;
  tmpvar_10 = ((final_1 / (1.0 + _Flash)) + (_Flash * _FlashColor));
  final_1 = tmpvar_10;
...
void main ()
{
  ...
  final_1 = tmpvar_7;
  lowp vec4 tmpvar_8;
  tmpvar_8 = (final_1 + (texture (_FXTex, xlv_TEXCOORD1.xy) * _Weight));
  final_1.w = tmpvar_8.w;
  mediump vec3 tmpvar_9;
  tmpvar_9 = (tmpvar_8.xyz + (Albedo_3.xyz * xlv_TEXCOORD0));
  final_1.xyz = tmpvar_9;
...
void main ()
{
  ...
  tmpvar_10 = tmpvar_15;
  lowp vec4 tmpvar_16;
  tmpvar_16 = (((final_1 * tmpvar_10) / (1.0 + _Flash)) + (_Flash * _FlashColor));
  final_1 = tmpvar_16;
...
void main ()
{
  ...
  shadow_10 = tmpvar_12;
  lowp vec4 tmpvar_13;
  tmpvar_13 = (((final_1 * shadow_10) / (1.0 + _Flash)) + (_Flash * _FlashColor));
  final_1 = tmpvar_13;
...
void main ()
{
  ...
  shadow_10 = tmpvar_13;
  lowp vec4 tmpvar_14;
  tmpvar_14 = (((final_1 * shadow_10) / (1.0 + _Flash)) + (_Flash * _FlashColor));
  final_1 = tmpvar_14;
