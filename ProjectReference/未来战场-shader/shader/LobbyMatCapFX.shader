Shader "VX/Character New/LobbyMatCapFX" {
Properties {
 _Color ("Main Color", Color) = (1,1,1,1)
 _SpecColor ("Specular Color", Color) = (0.5,0.5,0.5,1)
 _Shininess ("Shininess", Range(0.01,1)) = 0.078125
 _FXTex ("FX Mask (MONO)", 2D) = "black" {}
...
void main ()
{
  ...
  rim_1 = tmpvar_15;
  lowp vec3 tmpvar_16;
  tmpvar_16 = (((finalColor_4 + 
    (texture2D (_MatCap, tmpvar_13).xyz * tmpvar_7.z)
  ) + (rim_1 * tmpvar_7.x)) + texture2D (_FXTex, xlv_TEXCOORD0).xyz);
...
void main ()
{
  ...
  lowp vec3 tmpvar_16;
  tmpvar_16 = (((finalColor_4 + 
    (texture (_MatCap, tmpvar_13).xyz * tmpvar_7.z)
  ) + (rim_1 * tmpvar_7.x)) + texture (_FXTex, xlv_TEXCOORD0).xyz);
  finalColor_4 = tmpvar_16;
  lowp vec4 tmpvar_17;
  tmpvar_17.w = 1.0;
  tmpvar_17.xyz = tmpvar_16;
...
void main ()
{
  ...
  rim_1 = tmpvar_21;
  lowp vec3 tmpvar_22;
  tmpvar_22 = (((finalColor_4 + 
    (texture2D (_MatCap, tmpvar_19).xyz * tmpvar_7.z)
  ) + (rim_1 * tmpvar_7.x)) + texture2D (_FXTex, xlv_TEXCOORD0).xyz);
...
void main ()
{
  ...
  rim_1 = tmpvar_18;
  lowp vec3 tmpvar_19;
  tmpvar_19 = (((finalColor_4 + 
    (texture2D (_MatCap, tmpvar_16).xyz * tmpvar_7.z)
  ) + (rim_1 * tmpvar_7.x)) + texture2D (_FXTex, xlv_TEXCOORD0).xyz);
...
void main ()
{
  ...
  tmpvar_20 = (((finalColor_4 + 
    (texture (_MatCap, tmpvar_17).xyz * tmpvar_7.z)
  ) + (rim_1 * tmpvar_7.x)) + texture (_FXTex, xlv_TEXCOORD0).xyz);
