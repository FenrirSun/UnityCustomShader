...
Shader "Fairy Tails/Npc_OutLine" {
    Properties {
		...
		_FallRange ("FallRange", Range(0, 2) ) = 0
...
////// Lighting:
                ...
                half LightFallOff = (SAG.r*2*max(0,dot(normalDirection,lightDirection)+_FallRange));
                half StepFallOff = floor(LightFallOff * _FallOffstep) / (_FallOffstep - 1);
				//half StepFallOff = floor((LightFallOff+_FallOffstep) *2 ) ;
