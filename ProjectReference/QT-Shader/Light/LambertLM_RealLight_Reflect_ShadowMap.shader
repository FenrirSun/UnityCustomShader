...
Shader "TS_QT/Light/LambertLM_RealLight_Reflect_ShadowMap" {
Properties {
	...
	_PR_DiffWeight("Diff Weight", float) = 1

	ReflectUVOffsetForNormal("Reflect UV Offset", Range(0,1)) = 0
	_PR_ReflectWeight("Reflect Weight", float) = 0
...
SubShader {
	...
	#ifdef QT_PLANE_REFLECT_ON
		PlaneGroundReflect_Pixel(IN, o, color);
	#endif
