...
Shader "UI/Stencil_Alpha Additive Mask" 
{
	Properties 
	{
		...
		SubShader 
		{
			Pass 
			{
				...
				v2f vert (appdata_t v)
				{
					...
					o.texcoord += float2(_USpeed, _VSpeed) * _Time.y;
					//o.texcoord += float2(0.3 * _Time.y, 0.3 * _Time.y);
				...
				fixed4 frag (v2f i) : SV_Target
				{
					...
					return 2.0f * i.color * _TintColor * c * _Glow;
				}
				ENDCG 
			}
		}
