...
////// Lighting:
                ...
                float3 finalColor = saturate((saturate((_node_3562_var.r*pow(_Diffuse_var.a,2.0)*0.6))+(_Diffuse_var.rgb*_Color.rgb)));
